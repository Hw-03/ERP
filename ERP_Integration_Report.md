...
| `HA` | 고압 반제품 (High-voltage Sub-Assembly) | 47 |
...
총 93건. (별도 CSV: `ERP_Unmatched_A_Items.csv`)
...
동일한 파일 B/C 항목에 여러 파일 A 항목이 매핑된 경우: **326건**
