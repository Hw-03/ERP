...
created: 2026-05-21
updated: 2026-05-21
source_path: erp/frontend/lib/__tests__/api-stock-requests.test.ts
tags: [vault, code-note, auto-generated, stub]
---

# api-stock-requests.test.ts

> [!info] 자동 생성된 stub 노트
> 이 노트는 자동 보정으로 생성됐다. 원본 위치: [[erp/frontend/lib/__tests__/api-stock-requests.test.ts]]
