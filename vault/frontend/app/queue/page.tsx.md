...
- Source: `frontend/app/queue/page.tsx`
- Layer: `frontend`
...
- Parent hub: [[frontend/app/queue/queue|frontend/app/queue]]
...
> 전체 222줄 중 앞부분만 발췌했다. 실제 수정은 원본 파일을 기준으로 한다.
