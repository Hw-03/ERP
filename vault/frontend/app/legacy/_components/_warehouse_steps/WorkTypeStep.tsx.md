...
project: ERP
layer: frontend
source_path: frontend/app/legacy/_components/_warehouse_steps/WorkTypeStep.tsx
status: active
updated: 2026-04-27
source_sha: f05408d00363
tags:
  - erp
  - frontend
  - frontend-component
...
- Source: `frontend/app/legacy/_components/_warehouse_steps/WorkTypeStep.tsx`
- Layer: `frontend`
...
> 전체 226줄 중 앞부분만 발췌했다. 실제 수정은 원본 파일을 기준으로 한다.
