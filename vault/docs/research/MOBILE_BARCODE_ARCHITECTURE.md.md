...
project: ERP
layer: docs
source_path: docs/research/MOBILE_BARCODE_ARCHITECTURE.md
status: active
updated: 2026-04-27
source_sha: bc72175d628b
tags:
  - erp
  - docs
  - documentation
...
- Source: `docs/research/MOBILE_BARCODE_ARCHITECTURE.md`
- Layer: `docs`
- Kind: `documentation`
- Size: `32131` bytes
...
- Parent hub: [[docs/research/research|docs/research]]
- Related: [[docs/docs]]
...
> 전체 318줄 중 앞부분만 발췌했다. 실제 수정은 원본 파일을 기준으로 한다.
