...
source_path: "frontend/app/legacy/_components/_inventory_sections/inventoryFilter.ts"
...
# inventoryFilter.ts — inventoryFilter.ts 설명

## 이 파일은 무엇을 책임지나

`inventoryFilter.ts`는 대시보드/재고 화면의 목록, 상세, 필터, KPI 표시를 구성하는 화면 부품입니다.
