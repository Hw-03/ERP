...
source_path: "frontend/app/legacy/_components/_admin_sections/_admin_primitives/index.ts"
...
`index.ts`는 관리자 화면의 한 부분을 담당하는 TypeScript/React 코드입니다. 직원, 품목, BOM, 설정 같은 관리 작업과 연결됩니다.
