...
source_path: "frontend/app/legacy/_components/_warehouse_sections/DepartmentQueuePanel.tsx"
...
# DepartmentQueuePanel.tsx — DepartmentQueuePanel.tsx 설명

## 이 파일은 무엇을 책임지나

`DepartmentQueuePanel.tsx`는 입출고 요청 작성, 작업중 목록, 내 요청, 창고 승인함 같은 창고 업무 화면의 일부입니다.
