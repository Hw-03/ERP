...
source_path: "_attic/scripts/dev/bundle_frontend.bat"
...
# bundle_frontend.bat — bundle_frontend.bat 설명

## 이 파일은 무엇을 책임지나

`bundle_frontend.bat`는 현재 운영 코드가 아니라 과거 자료나 실험 결과를 보관한 참고 파일입니다.
