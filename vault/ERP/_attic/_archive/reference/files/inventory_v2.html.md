...
source_path: "_attic/_archive/reference/files/inventory_v2.html"
...
# inventory_v2.html — inventory_v2.html 설명

## 이 파일은 무엇을 책임지나

`inventory_v2.html`는 현재 운영 코드가 아니라 과거 자료나 실험 결과를 보관한 참고 파일입니다.
...
.row:last-child{border-bottom:none}.row:active{back
...
```
