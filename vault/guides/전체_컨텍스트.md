...
> - **창고 박스 자동 차감**: 박스에서 품목을 출고할 때 해당 박스의 수량이 자동으로 줄어듭니다. 차감 엔진은 `backend/app/services/box_depletion.py`, 규칙 설계는 `_attic/docs/warehouse-box-depletion-design.md`. 활성화 플래그(`box-tracking`)가 OFF일 때는 기존 방식으로 동작합니다.
