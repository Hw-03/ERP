        ...
        <div className="flex flex-1 min-h-0">
          ...
          <aside className="w-[380px] shrink-0 border-l border-[#1C2C4A] bg-[#0E1A34] flex flex-col">
            ...
            <div className="p-3 border-t border-[#1C2C4A] flex gap-2">
              <Btn size="lg" className="flex-1">초기화</Btn>
              <Btn variant="primary" size="lg" className="flex-[2]" icon={<Ic.ArrowRight className="w-full h-full"/>}>
                원자재 입고 확정 · 2건
              </Btn>
            </div>
          </aside>
...
window.DeskWarehouse = DeskWarehouse;
