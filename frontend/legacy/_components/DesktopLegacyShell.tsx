...
export function DesktopLegacyShell() {
  ...
  return (
    <div className="hidden h-screen overflow-hidden bg-black lg:block">
      <div className="relative flex h-screen overflow-hidden" style={{ background: LEGACY_COLORS.bg, color: LEGACY_COLORS.text }}>
        ...
        {historyOpen ? (
          <div
            className="sticky top-0 z-30 h-screen shrink-0 overflow-hidden border-l px-4 py-4 shadow-2xl"
