...
export function DesktopAdminView({
  ...
  if (!unlocked) {
    return (
      <div className="flex min-h-0 flex-1 items-center justify-center" style={{ padding: "10px" }}>
  ...
  return (
    <div className="flex min-h-0 flex-1">
      <div className="grid min-h-0 flex-1 grid-cols-[240px_minmax(0,1fr)] gap-5" style={{ padding: "10px" }}>
