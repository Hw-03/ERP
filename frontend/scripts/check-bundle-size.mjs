 ...
 *
 * .next-prod/static/chunks 의 *.js 합산 크기가 임계 (default 2.86 MB) 이내인지 검사.
...
// 2026-09-11: 불량 관리·자동 부서 라우팅 통합 실측 2.855 MB에 맞춰 예산을 0.02 MB 조정.
const MAX_MB = maxIdx >= 0 ? parseFloat(args[maxIdx + 1]) : 2.86;
