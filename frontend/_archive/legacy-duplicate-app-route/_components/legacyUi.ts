...
export const LEGACY_COLORS = {
  ...
  blue: "var(--c-blue)",
  blueSoft: "var(--c-soft-blue)",
  green: "var(--c-green)",
  greenSoft: "var(--c-soft-green)",
  red: "var(--c-red)",
  redSoft: "var(--c-soft-red)",
  yellow: "var(--c-yellow)",
  yellowSoft: "var(--c-soft-yellow)",
  purple: "var(--c-purple)",
  purpleSoft: "var(--c-soft-purple)",
  cyan: "var(--c-cyan)",
  cyanSoft: "var(--c-soft-cyan)",
  text: "var(--c-text)",
