  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center px-6 pt-5">
      <div className="mb-6 text-center">
        <div className="mb-3 inline-flex rounded-3xl p-4" style={{ background: LEGACY_COLORS.purpleSoft, color: LEGACY_COLORS.purple }}>
      ...
      {error ? (
        <div
          ...
          style={{
            borderColor: "rgba(242, 95, 92, 0.35)",
      ...
      <button onClick={submit} disabled={loading || pin.length < 4} className="desktop-action-primary mt-5 w-full max-w-[280px] disabled:opacity-50">
        {loading ? "확인 중..." : "확인"}
      </button>
    </div>
  );
