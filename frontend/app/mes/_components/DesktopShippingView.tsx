    ...
    >
      ...
      {structuredLayout ? (
        <div
          ...
          className={`grid ${layout === "requestBoard" ? "mt-2 flex-1 content-center grid-cols-2 grid-rows-2 gap-x-4 border-t pt-2" : "mt-2 grid-cols-[1.5fr_1fr_1fr_2fr] gap-x-2 border-t pt-1.5"}`}
