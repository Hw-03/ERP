...
export function DailyWorkReportEditor({
  ...
  return (
    <section className={`rounded-[20px] border p-4 lg:p-5 ${fillAvailableHeight ? "lg:flex lg:min-h-[360px] lg:flex-1 lg:flex-col" : ""}`} style={{ background: LEGACY_COLORS.s1, borderColor: LEGACY_COLORS.border }}>
      ...
      <textarea
        ...
        className={`mt-4 min-h-44 w-full resize-none rounded-[16px] border px-4 py-3.5 text-sm leading-7 outline-none transition focus-visible:ring-2 ${fillAvailableHeight ? "lg:min-h-[220px] lg:flex-1" : ""}`}
