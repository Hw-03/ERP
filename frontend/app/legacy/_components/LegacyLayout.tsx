        ...
        <main className="flex-1 overflow-y-auto px-[14px] py-[14px]">
          <div className="mb-3 space-y-2">
            ...
            <div className="flex gap-2 text-[10px] font-bold">
              <Link
                href="/queue"
                className="rounded-full px-[10px] py-[4px] transition-all hover:brightness-110"
            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-1 flex-col items-center gap-[3px] border-none bg-transparent px-1 py-1 transition-colors hover:bg-white/[0.12]"
                >
