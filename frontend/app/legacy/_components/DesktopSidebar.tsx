...
export function DesktopSidebar({
  ...
  return (
    ...
    >
      <div className="mb-6 overflow-hidden rounded-xl bg-white px-3 py-2">
        <Image src="/dexcowin-logo.png" alt="DEXCOWIN" width={150} height={60} className="h-auto w-full" priority />
      </div>
