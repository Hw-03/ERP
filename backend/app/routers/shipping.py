...
def _to_response(
    ...
    return ShippingRequestResponse(
        ...
        final_pa_mes_code=req.final_pa_item.mes_code if req.final_pa_item else None,
        final_pf_item_id=req.final_pf_item_id,
        final_pf_item_name=req.final_pf_item.item_name if req.final_pf_item else None,
        final_pf_mes_code=req.final_pf_item.mes_code if req.final_pf_item else None,
