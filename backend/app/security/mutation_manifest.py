...
SERVICE_ACTOR_CONSUMERS: dict[str, str] = {
    ...
    "app.services.defect_actions.unquarantine_inventory_bulk": "actor",
    ...
    "app.services.shipping_actions.pickup_cancel_command": "actor",
    "app.services.shipping_actions.pickup_cancel": "actor",
    "app.services.shipping_actions.pickup_complete_command": "actor",
    "app.services.shipping_actions.pickup_complete": "actor",
    "app.services.shipping_actions.prepare_cancel_command": "actor",
    "app.services.shipping_actions.prepare_cancel": "actor",
    "app.services.shipping_actions.prepare_complete_command": "actor",
    ...
    "app.services.sr_execution.reroute_and_preflight_dept_to_warehouse": "actor",
...
SERVICE_READ_ONLY_EXPORTS: frozenset[str] = frozenset(
    {
        ...
        "app.services.approval_rules.approval_kind",
        ...
        "app.services.command_idempotency.fingerprint_shipping_command",
        ...
        "app.services.inv_transfer.lock_items_for_department_routing",
        ...
        "app.services.io_persist.normalize_automatic_routes_with_bom_token_refresh",
        "app.services.io_preview.automatic_department_headers",
        "app.services.io_preview.has_declared_custom_process_bom",
        "app.services.io_preview.has_included_manual_line",
        "app.services.io_preview.normalize_automatic_department_routes",
        "app.services.io_preview.normalize_process_sub_type",
        ...
        "app.services.shipping_workflow_operations.latest_operation",
        "app.services.shipping_workflow_operations.lock_request",
        "app.services.shipping_workflow_operations.next_operation_key",
        ...
        "app.services.sr_validation.requires_exact_defect_selection",
        "app.services.sr_validation.validate_line_shape_for_request_type",
        "app.services.stock_availability.bulk_reserved_by_cell",
        "app.services.stock_availability.bulk_reserved_by_item",
        "app.services.stock_availability.calculate_available",
        "app.services.stock_availability.figure_for_cell",
        "app.services.stock_availability.figures_for_cells",
        "app.services.stock_availability.location_available_quantity",
        ...
        "app.services.weekly_report_scope.includes_ceramic_tube_housing_for_week",
        "app.services.weekly_report_scope.includes_vacuum_generator_for_week",
        "app.services.weekly_report_scope.is_ceramic_tube_housing_weekly_item",
        "app.services.weekly_report_scope.is_vacuum_generator_weekly_item",
        "app.services.weekly_report_scope.is_weekly_report_item",
        "app.services.weekly_report_scope.weekly_report_group_code",
        "app.services.weekly_report_scope.weekly_report_item_clause",
        "app.services.weekly_report_scope.weekly_report_item_sort_key",
    }
)
...
SERVICE_INFRASTRUCTURE_MUTATION_REASONS: dict[str, str] = {
    ...
    "app.services.operator_session.renew_operator_session": _AUTH_INFRASTRUCTURE_REASON,
