...
REQUIRED_TESTS = [
    ...
    "tests/concurrency/test_operator_session_postgres.py::test_postgres_activity_waits_for_employee_lock_and_rechecks_expiry",
    "tests/concurrency/test_operator_session_postgres.py::test_postgres_logout_wins_over_late_activity_without_session_revival",
    ...
    "tests/concurrency/test_cp4_command_postgres.py::test_postgres_dept_to_warehouse_approve_cancel_has_one_inventory_winner",
    ...
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_16_backup_restore_proves_staging_manifest_and_target_safety",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_restore_recovers_cutover_before_missing_source_validation",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_restore_recovers_created_candidate_before_missing_source_validation",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_restore_recovers_hard_crash_after_created_oid_receipt",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_restore_recovers_cross_root_crash_before_oid_marker",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_backup_validation_fences_writer_before_evidence",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_backup_validation_rejects_different_mutation_cluster",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_backup_validation_recovers_hard_crash_exact_candidate",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_backup_validation_recovers_cross_root_crash_before_oid_marker",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_evidence_inventory_uses_one_repeatable_read_snapshot",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_candidate_is_admission_fenced_before_evidence",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_holds_admission_and_advisory_fences",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_operation_scope_holds_cluster_lock_across_runtime_roots",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_rejects_wrong_live_cluster_before_mutation",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_rejects_unsafe_receipt_before_catalog_mutation",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_recovers_finalization_failure_in_same_run",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_prepared_marker_recovers_when_first_local_receipt_publish_failed",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_recovers_cross_root_hard_crash_from_cluster_marker",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_rejects_marker_mismatch_before_catalog_mutation",
    "tests/ops/test_backup_manifest_postgres.py::test_postgres_cutover_rejects_local_receipt_identity_mismatch_before_mutation",
]
