    ...
    <div className="pb-4">
      ...
      <div className="mb-[6px] flex items-center justify-between px-[2px]">
        <div className="text-[10px] font-mono" style={{ color: LEGACY_COLORS.muted2 }}>
          {displayRows.length}개 품목 · 재고 {formatNumber(totals.totalQuantity)}
          {totals.totalPending > 0 ? (
            <span style={{ color: LEGACY_COLORS.cyan }}> · 예약 {formatNumber(totals.totalPending)}</span>
          ) : null}
        </div>
